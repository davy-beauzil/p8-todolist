 ...
 */
final class Version20230419132838 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add author on task';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE task ADD author_id VARCHAR(255) DEFAULT NULL');
        $this->addSql(
